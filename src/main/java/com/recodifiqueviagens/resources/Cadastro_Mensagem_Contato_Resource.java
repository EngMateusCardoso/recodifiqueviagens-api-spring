...
public class Cadastro_Mensagem_Contato_Resource {
	...
	@PutMapping(value = "/{Id_Msg}")
	public Cadastro_Mensagem_Contato update(@PathVariable("Id_Msg") Long Id_Msg, @RequestBody Cadastro_Mensagem_Contato msg) {
		return service.update(Id_Msg, msg);
	}
